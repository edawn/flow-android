...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DBHelper.DATABASE_NAME, null, DBHelper.DATABASE_VERSION) {
    ...
    companion object {
        ...
        val DATABASE_NAME = "flow"
        val DATABASE_VERSION = 1

        /**
         * This table contains all transactions.
         */
        val TRANSACTIONS_TABLE_NAME = "transactions"
        /**
         * The id of this transaction
         */
        val TRANSACTIONS_KEY_ID = "id"
        /**
         * Indicates that this transaction has been removed and should not be processed any further
         */
        val TRANSACTIONS_KEY_IS_REMOVED = "is_removed"

        val TRANSACTIONS_TABLE_CREATE =
         ...
         */
        val EDITS_KEY_TRANSACTION = "transaktion"
        /**
         ...
         */
        val EDITS_KEY_SEQUENCE = "sequence"
        /**
         ...
         */
        val REGULARS_TABLE_NAME = "regulars"

        /**
         * The id of this transaction
         */
        val REGULARS_KEY_ID = "id"
        /**
         * The time this transaction will be executed for the first time;
         * in ms since the epoch; including
         */
        val REGULARS_KEY_TIME_FIRST = "time_first"
        /**
         ...
         */
        val REGULARS_KEY_IS_SPREAD = "is_spread"
        /**
         * Do not use this transaction when calculating the balance
         */
        val REGULARS_KEY_IS_DISABLED = "is_disabled"
        /**
         * The user-set description for this transaction
         */
        val REGULARS_KEY_DESCRIPTION = "description"
        /**
         * The user-set currency for this transaction; a ISO 4217 currency code
         */
        val REGULARS_KEY_CURRENCY = "currency"
        /**
         * The user-set transaction amount; in minor currency units (usually cents); negative values indicate spending
         */
        val REGULARS_KEY_AMOUNT = "amount"
         ...
         */
        val TRANSACTIONS_EDITS_TIME_SPAN_QUERY =
                "SELECT " + EDITS_TABLE_NAME + ".*, " + TRANSACTIONS_KEY_IS_REMOVED + " FROM " + EDITS_TABLE_NAME + " INNER JOIN " +
                        "(SELECT " + TRANSACTIONS_KEY_IS_REMOVED +
                        ", " + EDITS_TABLE_NAME + "." + EDITS_KEY_ID + ", MAX(" + EDITS_KEY_SEQUENCE + ") AS maxsequence " +
                        "FROM " + TRANSACTIONS_TABLE_NAME + ", " + EDITS_TABLE_NAME + " WHERE " + TRANSACTIONS_TABLE_NAME + "." + TRANSACTIONS_KEY_ID +
         ...
         */
        @JvmOverloads fun queryRegulars(dbHelper: DBHelper, includeDisabled: Boolean = false): ArrayList<RegularModel> {
            val db = dbHelper.readableDatabase
            val cursor = db.rawQuery(if (includeDisabled) REGULARS_QUERY else ACTIVE_REGULARS_QUERY, null)

            val regulars = ArrayList<RegularModel>(cursor.count)
            while (cursor.moveToNext()) {
                regulars.add(RegularModel(cursor))
            }
            cursor.close()
            return regulars
        }
